            ...
            <div id="chat-global-container">
                <div id="first-chat-part" class="relative">
                    ...
                    <div class="friends-chat-search-container">
                        <div class="section-title">Debates: </div>
                ...
                <div id="no-discussion-yet">
                    <div class="flex-justify-column" style="text-align: center">
                        <h2>Nao tens nenhuma Mensagem Seleccionada</h2>
                        <p class="regular-text">Seleccione uma das Mensagens existentes , ou inicie uma nova Conversa.</p>
                        <a href="" class="new-message-button">Nova Mensagem</a>
                    </div>
                </div>
            </div>
        </div>
