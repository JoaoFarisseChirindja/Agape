        ...
        <div id="global-container">
            ...
            <div id="master-middle">
                ...
                <div class="no-search-container flex-row-column">
                    <p class="no-search-results">Sem resultados da Pesquisa.</p>
                </div>

                <div class="flex-row-column empty-search">
                    <p style="margin: 0">Digite no Campo a cima para pesquisar.</p>
                </div>
                ...
                <div class="search-result-type-container">
                    <div style="padding: 8px">
                        <div class="flex-space">
                            <h1 class="title-style-4">Grupos</h1>
                            <a href="" class="link-style-2">Ver Mais</a>
                        </div>
                        <p class="label-style-2">Exibindo <span>4</span> of <span>7</span> Resultados</p>
                    </div>
                    <div class="search-result">
                        <?php
                            foreach($searchUsersResult as $u) {
