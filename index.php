...
<head>
    ...
    <title>AGAPE</title>
    <link rel='shortcut icon' type='image/x-icon' href='public/assets/images/favicons/large.PNG' />
                ...
                <div id="posts-container">
                    <?php if(count($journal_posts) == 0) { ?>
                        <div id="empty-posts-message">
                            <h2>Adione os Seus Irmaos , e Siga-os para ver seus Posts e Testemunhos ..</h1>
                            <p>Clica <a href="http://127.0.0.1/CHAT/search.php" class="link" style="color: rgb(66, 219, 66)">Aqui</a> Para ir para Pagina de Pesquisas</p>
                        </div>
                    <?php } else { 
