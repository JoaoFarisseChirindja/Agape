...
<head>
    ...
    <title>AGAPE- <?php echo $fetched_user->getPropertyValue("username"); ?></title>
                ...
                <div class="user-info-section row-v-flex">
                    <a href="" class="user-info-section-link">
                        <div>
                            ...
                            <p class="regular-text-style-2">Postagens</p>
                        </div>
                    </a>
                    <a href="" class="user-info-section-link">
                        <div>
                            <h2 class="title-style-4"><?php echo $followers_number; ?></h2>
                            <p class="regular-text-style-2">Seguidores</p>
                        </div>
                    </a>
                    <a href="" class="user-info-section-link">
                        <div>
                            <h2 class="title-style-4"><?php echo $followed_number; ?></h2>
                            <p class="regular-text-style-2">A seguir</p>
                        </div>
                    </a>
                    <a href="" class="user-info-section-link">
                        <div>
                            <h2 class="title-style-4"><?php echo $friends_number; ?></h2>
                            <p class="regular-text-style-2">Amigos</p>
                        </div>
                    </a>
                </div>
                <div class="user-info-section">
                    <h2 class="title-style-4">Sobre</h2>
...
METADATA;
                ...
                <div class="user-info-section">
                    <div class="flex-space">
                        ...
                        <a href="" class="link-style-1">Mostrar Tudo</a>
                    </div>
                ...
                <div id="posts-container">
                    <?php if(count($posts) == 0) { ?>
                        <div id="empty-posts-message">
                            <h2>Tenta Adicionar Seus Amigos, ou siga-os para ver as suas Postagens ..</h1>
