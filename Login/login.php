    ...
    <main>
        <div class="login-img-reg-container">
            <div id="left-asset-wrapper">
                <h2 id="login-left-text"></h2>
                <img src="../public/assets/images/preview.jpg" id="login-image-preview" alt="">
            </div>
            <div id="registration-section">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" class="flex-column">
                    ...
                    <div class="classic-form-input-wrapper">
                        <label for="lastname" class="classic-label">Apelido</label>
                    ...
                    <div class="classic-form-input-wrapper">
                        <label for="username" class="classic-label">Apelido</label>
                    ...
                    <div class="classic-form-input-wrapper">
                        <label for="password_again" class="classic-label">Digite o password novamente</label>
