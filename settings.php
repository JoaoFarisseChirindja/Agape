        ...
        <div id="setting-master-container">
            ...
            <div>
                ...
                <div style="margin-top: 26px">
                    <label for="fullname" class="setting-label1">Dados do Perfil</label>
                    <p class="input-hint">YPodes Ter 6 itens exibidos em uma tabela no teu perfil</p>
                    <div class="flex">
